...
class ResCompany(models.Model):
    ...
    is_compte_banque_ids = fields.One2many('is.compte.banque', 'company_id', 'Comptes bancaires')
    ...
    is_interface         = fields.Selection([
            ('opta-s', u'Opta-S'),
            ('sgp'   , u'SGP'),
        ], "Interface", default='opta-s', help="Utilisé en particulier pour la gestion du champ 'Nb unités réalisées' des activités")
